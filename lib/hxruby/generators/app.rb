    ...
    class App
      ...
      def render_gem_layers_doc
        [
          ...
          "   ```",
          "",
          "   The optional `--yard` command is service-specific: the constant must be explicit, the checked Ruby file stays inside the app root, and only complete positional `@param`/`@return` signatures with supported scalar, nilable, Boolean, or Array types are generated. Unsupported methods remain review-marked and omitted instead of becoming `Dynamic`; Ruby source is never executed.",
          "",
          "   Capture what RailsHx can prove mechanically: gem version/path, public constants, RBS signatures, explicitly selected YARD service signatures, source-defined modules/methods, Rails routes, generated migrations, initializers, model concerns, controller helpers, and test helpers.",
          "",
