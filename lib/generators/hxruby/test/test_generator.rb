...
if defined?(Rails::Generators::Base)
  module Hxruby
    class TestGenerator < Rails::Generators::NamedBase
      ...
      desc "Generate a Haxe-authored Rails test source using @:railsTests"
      ...
      class_option :adapter, type: :string, default: "minitest", desc: "Test adapter: minitest, rspec, or auto"
      ...
      def generate_test
        ...
        args += ["--adapter", hxruby_option(:adapter, "minitest")]
