...
class H {
	...
	public static macro function preloadLinkTag(source:Expr, attrs:Expr):Expr {
		return macro rails.action_view.HtmlNode.PreloadLinkTag($source, $attrs);
	}

	public static macro function javascriptIncludeTag(source:Expr, attrs:Expr):Expr {
	...
	public static macro function videoTag(source:Expr, attrs:Expr):Expr {
		return macro rails.action_view.HtmlNode.VideoTag($source, $attrs);
	}
	...
	public static macro function smsTo(phone:Expr, label:Expr, attrs:Expr):Expr {
		return macro rails.action_view.HtmlNode.SmsTo($phone, $label, $attrs);
	}
	...
	public static macro function currentCycle(name:Expr):Expr {
	...
	public static macro function textFieldTag(name:Expr, value:Expr, attrs:Expr):Expr {
		return macro rails.action_view.HtmlNode.TextFieldTag($name, $value, $attrs);
	}

	public static macro function searchFieldTag(name:Expr, value:Expr, attrs:Expr):Expr {
		return macro rails.action_view.HtmlNode.SearchFieldTag($name, $value, $attrs);
	}

	public static macro function emailFieldTag(name:Expr, value:Expr, attrs:Expr):Expr {
	...
	public static macro function numberFieldTag(name:Expr, value:Expr, attrs:Expr):Expr {
	...
	public static macro function colorFieldTag(name:Expr, value:Expr, attrs:Expr):Expr {
	...
	public static macro function timeFieldTag(name:Expr, value:Expr, attrs:Expr):Expr {
		return macro rails.action_view.HtmlNode.TimeFieldTag($name, $value, $attrs);
	}

	public static macro function datetimeFieldTag(name:Expr, value:Expr, attrs:Expr):Expr {
		return macro rails.action_view.HtmlNode.DatetimeFieldTag($name, $value, $attrs);
	}

	public static macro function monthFieldTag(name:Expr, value:Expr, attrs:Expr):Expr {
	...
	public static macro function fileFieldTag(name:Expr, attrs:Expr):Expr {
	...
	public static macro function checkBoxTag(name:Expr, value:Expr, checked:Expr, attrs:Expr):Expr {
	...
	public static macro function select(name:Expr, options:Expr, attrs:Expr):Expr {
		return macro rails.action_view.HtmlNode.FormSelect($name, $options, $attrs);
	}
