...
function expectMigrationSnapshotOperationsOutput() {
  ...
  writeFileSync(join(migrationSnapshotOpsSourceDir, "migrations", "SnapshotOperationsMigration.hx"), [
    ...
    "\t\tAddIndex(\"audit_events\", \"title\", {name: \"index_audit_events_on_title_fulltext\", indexType: \"fulltext\"}),",
    "\t\tReversible([",
  ...
  for (const expected of [
    ...
    'add_index :audit_events, :title, name: "index_audit_events_on_title_fulltext", type: :fulltext',
