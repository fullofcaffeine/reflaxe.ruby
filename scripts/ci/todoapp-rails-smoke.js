...
function expectMigrationSnapshotOperationsOutput() {
  ...
  writeFileSync(join(migrationSnapshotOpsSourceDir, "migrations", "SnapshotOperationsMigration.hx"), [
    ...
    "\t\t\t\tReference(\"user\", {nullable: false, type: UuidPrimaryKey, comment: \"Actor reference\", indexName: \"index_audit_events_on_actor\", foreignKeyToTable: \"users\", foreignKeyPrimaryKey: \"id\", foreignKeyOnDelete: Nullify, foreignKeyOnUpdate: Cascade, foreignKeyDeferrable: Immediate}),",
  ...
  for (const expected of [
    ...
    't.references :user, null: false, type: :uuid, comment: "Actor reference", index: { name: "index_audit_events_on_actor" }, foreign_key: { to_table: :users, primary_key: :id, on_delete: :nullify, on_update: :cascade, deferrable: :immediate }',
