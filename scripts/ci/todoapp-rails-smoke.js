...
function expectMigrationSnapshotOperationsOutput() {
  ...
  writeFileSync(join(migrationSnapshotOpsSourceDir, "migrations", "SnapshotOperationsMigration.hx"), [
    ...
    "\t\t\t\tReference(\"user\", {nullable: false, type: UuidPrimaryKey, foreignKey: true}),",
    ...
    "\t\t]),",
    "\t\tReversible([",
    "\t\t\tCreateJoinTable(\"audit_events\", \"users\", {tableName: \"audit_events_users\", nullable: false, index: false, ifNotExists: true})",
    "\t\t], [",
    "\t\t\tDropJoinTable(\"audit_events\", \"users\", {tableName: \"audit_events_users\", ifExists: true})",
    "\t\t]),",
    "\t\tAddReferenceIfNotExists(\"audit_events\", \"account\", {type: StringPrimaryKey, index: false}),",
    ...
    "\t\t\tAddColumnIfNotExists(\"audit_events\", \"legacy_notes\", TextColumn({}))",
    "\t\t]),",
    "\t\tAddCompositeIndex(\"audit_events\", [\"account_id\", \"title\"], {comment: \"Account title lookup\"}),",
    "\t\tReversible([",
  ...
  for (const expected of [
    ...
    "create_join_table :audit_events, :users, table_name: :audit_events_users, if_not_exists: true, column_options: { null: false, index: false }",
    "drop_join_table :audit_events, :users, table_name: :audit_events_users, if_exists: true",
    "add_reference :audit_events, :account, type: :string, index: false, if_not_exists: true",
    ...
    'add_index :audit_events, [:account_id, :title], comment: "Account title lookup"',
