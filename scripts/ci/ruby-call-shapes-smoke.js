...
for (const expected of [
  ...
  /describe_value(?:__hx\d+)? = ->\(\*haxe_args(?:__hx\d+)?\) do/,
  /NativeInterop\.describe_optional\(count: keyword_options(?:__hx\d+)?\["count"\], name: keyword_options(?:__hx\d+)?\["name"\]/,
  ...
  /NativeInterop\.each\(\*haxe_args(?:__hx\d+)?, &callable_block(?:__hx\d+)?\)/,
