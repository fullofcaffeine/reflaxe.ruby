...
try {
  ...
  const tasksCheck = [
    ...
    "expected = %w[hxruby:compile hxruby:compile:client hxruby:watch hxruby:watch:client hxruby:gen:app hxruby:gen:model hxruby:gen:routes]",
