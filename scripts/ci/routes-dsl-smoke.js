...
const deviseDecl = routeManifest.declarations.find((decl) => decl.kind === "deviseFor");
if (
  !deviseDecl
  || deviseDecl.resource !== "users"
  || deviseDecl.expectedMapping?.name !== "user"
  || deviseDecl.expectedMapping?.className !== "User"
  || deviseDecl.expectedMapping?.path !== "users"
  || deviseDecl.contract?.type !== "app.auth.UserAuth"
  || deviseDecl.contract?.field !== "scope"
  || deviseDecl.contract?.schema !== 1
) {
  console.error("[routes-dsl] route manifest did not record the DeviseHx deviseFor semantic contract.");
  process.exit(1);
}
const adminDeviseDecls = routeManifest.declarations.filter((decl) => decl.kind === "deviseFor" && decl.resource === "admins");
if (
  adminDeviseDecls.length !== 2
  || !adminDeviseDecls.some((decl) => JSON.stringify(decl.options) === JSON.stringify({ only: ["sessions"] }))
  || !adminDeviseDecls.some((decl) => JSON.stringify(decl.options) === JSON.stringify({ skip: ["sessions"] }))
) {
  console.error("[routes-dsl] route manifest did not record typed DeviseHx only/skip split mappings.");
  process.exit(1);
}
...
for (const expected of [
  ...
  'patch "posts/:id", to: "posts#update", as: :patch_post',
  'put "posts/:id", to: "posts#update"',
  'delete "posts/:id", to: "posts#destroy", as: :delete_post',
  'options "posts/options", to: "posts#options"',
  'head "posts/ping", to: "posts#head_check", as: :post_ping',
  ...
  'resources :legacy_posts, controller: "posts", only: [:index]',
  'resource :profile, controller: "profiles", only: [:show, :update]',
  'resource :legacy_profile, controller: "profiles", only: [:show]',
  "namespace :admin do",
...
expectInvalidRouteDslFailure("DeviseHx literal route resource", [
  ...
  "class AppRoutes {",
  "\tstatic final routes = {",
  "\t\tDeviseRoutes.deviseFor(\"users\");",
  "\t};",
  "}",
  "",
], "expects a direct generated Devise scope field");

expectInvalidRouteDslFailure("DeviseHx constructed scope", [
  "package routes;",
  "",
  ...
  "class AppRoutes {",
  "\tstatic final routes = {",
  "\t\tDeviseRoutes.deviseFor(DeviseScope.of(ScopeName.named(\"user\"), RouteResource.named(\"users\"), User));",
  "\t};",
  "}",
  "",
...
expectInvalidRouteDslFailure("DeviseHx unsupported option", [
  ...
  "class AppRoutes {",
  "\tstatic final routes = {",
  "\t\tDeviseRoutes.deviseFor(UserAuth.scope, {path: \"account\"});",
  "\t};",
  "}",
  "",
], "unsupported option \"path\"");

expectInvalidRouteDslFailure("DeviseHx string route group", [
  "package routes;",
  "",
  "import app.auth.UserAuth;",
  "import devisehx.routes.DeviseRoutes;",
  ...
  "}",
  "",
], "entries must be DeviseRouteGroup enum tokens");

expectInvalidRouteDslFailure("DeviseHx combines only and skip", [
  "package routes;",
  "",
  "import app.auth.UserAuth;",
  ...
  "class AppRoutes {",
  "\tstatic final routes = {",
  "\t\tDeviseRoutes.deviseFor(UserAuth.scope, {only: [Sessions], skip: [Passwords]});",
  "\t};",
  "}",
  "",
], "cannot combine only and skip");

expectInvalidRouteDslFailure("DeviseHx missing metadata", [
  "package routes;",
  "",
  "import app.auth.PlainAuth;",
  "import devisehx.routes.DeviseRoutes;",
  "",
  "@:railsRoutes",
  "class AppRoutes {",
  "\tstatic final routes = {",
  "\t\tDeviseRoutes.deviseFor(PlainAuth.scope);",
  "\t};",
  "}",
  "",
...
function writeValidFixture() {
  mkdirSync(join(sourceDir, "app", "auth"), { recursive: true });
...
function writeCommonTypes(baseDir) {
  mkdirSync(join(baseDir, "app", "auth"), { recursive: true });
  ...
  writeFileSync(join(baseDir, "models", "User.hx"), [
    "package models;",
    "",
    "@:railsModel(\"users\")",
  ...
  writeFileSync(join(baseDir, "models", "Admin.hx"), [
    "package models;",
    "",
    "@:railsModel(\"admins\")",
    "class Admin extends rails.active_record.Base<Admin> {}",
    "",
  ].join("\n"));
  writeFileSync(join(baseDir, "app", "auth", "UserAuth.hx"), [
    "package app.auth;",
    "",
    "import devisehx.DeviseScope;",
    "import devisehx.RouteResource;",
  ...
  writeFileSync(join(baseDir, "app", "auth", "PlainAuth.hx"), [
    "package app.auth;",
    "",
    "import devisehx.DeviseScope;",
    "import devisehx.RouteResource;",
  ...
  writeFileSync(join(baseDir, "app", "auth", "AdminAuth.hx"), [
    "package app.auth;",
    "",
    "import devisehx.DeviseScope;",
    "import devisehx.RouteResource;",
