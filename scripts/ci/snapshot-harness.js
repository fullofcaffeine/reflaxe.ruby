...
const cases = [
  ...
  {
    name: "ruby_owned_blocks",
    sourceRoot: "test/ruby_owned_blocks/src_haxe",
    files: [
      "block_concern.rb",
  ...
  {
    name: "ruby_keyword_rest",
    sourceRoot: "test/ruby_keyword_rest/src_haxe",
    files: [
      "hxruby/core.rb",
  ...
  {
    name: "ruby_callable_inheritance",
    sourceRoot: "test/ruby_callable_inheritance/src_haxe",
    files: [
      "block_api.rb",
      "block_base.rb",
      "block_child.rb",
