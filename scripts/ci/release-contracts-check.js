...
const open3Coverage = rubyStdlibCoverage.domains?.find((domain) => domain.id === "library.open3");
if (
  open3Coverage?.coverageStatus !== "implemented-public" ||
  JSON.stringify(open3Coverage.facadePaths) !==
    JSON.stringify([
      "std/ruby/Open3.hx",
  ...
  !open3Coverage.evidence?.includes("npm run test:open3-facade") ||
...
expectIncludes(packageJson.scripts["test:rails-runtime"] ?? "", "REQUIRE_RAILS=1 npm run test:turbo-streams", "package.json scripts");
...
expectIncludes(haxelibPackageBuilder, `"std/ruby/TimeParsing.hx"`, "Haxelib Time parsing package builder source lock");
expectIncludes(haxelibPackageBuilder, `"std/ruby/Date.hx"`, "Haxelib Date package builder source lock");
expectIncludes(haxelibPackageBuilder, `"std/rails/active_support/RailsTime.hx"`, "Haxelib Rails Time package builder source lock");
expectIncludes(haxelibPackageBuilder, `"std/rails/active_support/TimeZone.hx"`, "Haxelib Rails TimeZone package builder source lock");
expectIncludes(haxelibPackageBuilder, `"std/rails/active_support/TimeWithZone.hx"`, "Haxelib Rails TimeWithZone package builder source lock");
expectIncludes(haxelibPackageBuilder, `"docs/temporal-apis.md"`, "Haxelib temporal guide source lock");
...
expectIncludes(haxelibPackageCheckText, "src/ruby/Open3.hx", "Haxelib typed Open3 package check");
expectIncludes(haxelibPackageCheckText, "src/ruby/Open3Capture.hx", "Haxelib typed Open3 capture package check");
...
expectIncludes(haxelibPackageCheckText, "src/ruby/TimeParsing.hx", "Haxelib typed Time parsing package check");
...
expectIncludes(haxelibPackageCheckText, "src/rails/active_support/RailsTime.hx", "Haxelib typed Rails Time package check");
expectIncludes(haxelibPackageCheckText, "src/rails/active_support/TimeZone.hx", "Haxelib typed Rails TimeZone package check");
expectIncludes(haxelibPackageCheckText, "src/rails/active_support/TimeWithZone.hx", "Haxelib typed Rails TimeWithZone package check");
expectIncludes(haxelibPackageCheckText, "RailsTimePackageContract.hx", "Haxelib packaged Rails temporal compile check");
...
expectIncludes(gemPackageCheck, "std/ruby/TimeParsing.hx", "Ruby gem Time parsing package check");
expectIncludes(gemPackageCheck, "std/rails/active_support/RailsTime.hx", "Ruby gem Rails Time package check");
expectIncludes(gemPackageCheck, "std/rails/active_support/TimeZone.hx", "Ruby gem Rails TimeZone package check");
expectIncludes(gemPackageCheck, "std/rails/active_support/TimeWithZone.hx", "Ruby gem Rails TimeWithZone package check");
...
expectIncludes(gemPackageCheck, "std/ruby/Open3.hx", "Ruby gem typed Open3 package check");
