...
class TodoStreams {
	...
	// string literals. `StreamTarget.named(...)` is an explicit boundary: the
	// value still lowers to Rails' normal DOM target name, but plain strings do
	// not satisfy TurboStreams APIs elsewhere.
