...
- A Haxe-authored typed ActionView partial through `@:railsTemplateAst(...)`, `H`, `HtmlNode`, and `HtmlAttr`; the compiler type-checks embedded expressions such as `todo.title` before emitting ERB.
