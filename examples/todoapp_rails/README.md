...
- Incremental raw ERB migration: the index template still owns the full page shell, but delegates the typed composer, list, dashboard, and form islands to generated HHX partials.
