...
class RubyNaming {
	...
	static final RESERVED_CONSTANTS = [
		"ARGF", "ARGV", "Array", "BasicObject", "Class", "Data", "Dir", "Encoding", "ENV", "Exception", "FalseClass", "File", "Float",
		"Hash", "Integer", "IO", "Kernel", "Module", "NilClass", "Numeric", "Object", "Proc", "Range", "Regexp", "String", "Struct",
