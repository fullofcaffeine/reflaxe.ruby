...
| Turbo, streams, DOM hooks | Typed default | `StreamTarget`, `StreamName`, shared hook constants/abstracts. | Literal CSS classes are fine for local styling; behavior hooks should be typed when repeated. |
