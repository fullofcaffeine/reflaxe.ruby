...
class Main
  ...
  def self.main()
    ...
    puts(HXRuby.stringify(RubyInterop.describe_details(name: "interop", tags: [:safe, :typed], count: count__hx16885)))
    RubyInterop.each([4, 5]) { |value__hx16958| puts(HXRuby.stringify(value__hx16958)) }
    RubyInterop.with_options([6, 7], prefix: "interop", tags: [:block], count: count__hx16885) do |value__hx16959|
      Kernel.print("interop=")
      puts(HXRuby.stringify(value__hx16959))
    end
