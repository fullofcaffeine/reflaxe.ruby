...
class Main
  ...
  def self.main()
    ...
    puts(HXRuby.stringify(RubyInterop.describe_details(name: "interop", tags: [:safe, :typed], count: count__hx18946)))
    RubyInterop.each([4, 5]) { |value__hx19019| puts(HXRuby.stringify(value__hx19019)) }
    RubyInterop.with_options([6, 7], prefix: "interop", tags: [:block], count: count__hx18946) do |value__hx19020|
      Kernel.print("interop=")
      puts(HXRuby.stringify(value__hx19020))
    end
