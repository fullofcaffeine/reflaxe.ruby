...
class Main
  ...
  def self.main()
    ...
    puts(HXRuby.stringify(RubyInterop.describe_details(name: "interop", tags: [:safe, :typed], count: count__hx19490)))
    RubyInterop.each([4, 5]) { |value__hx19563| puts(HXRuby.stringify(value__hx19563)) }
    RubyInterop.with_options([6, 7], prefix: "interop", tags: [:block], count: count__hx19490) do |value__hx19564|
      Kernel.print("interop=")
      puts(HXRuby.stringify(value__hx19564))
    end
