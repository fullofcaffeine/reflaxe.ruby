...
class Main
  ...
  def self.main()
    ...
    puts(HXRuby.stringify(RubyInterop.describe_details(name: "interop", tags: [:safe, :typed], count: count__hx0)))
    RubyInterop.each([4, 5]) { |value__hx0| puts(HXRuby.stringify(value__hx0)) }
    RubyInterop.with_options([6, 7], prefix: "interop", tags: [:block], count: count__hx0) do |value__hx1|
