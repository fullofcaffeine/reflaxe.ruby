...
class Main
  ...
  def self.main()
    ...
    puts(HXRuby.stringify(RubyInterop.describe_details(name: "interop", tags: [:safe, :typed], count: count__hx18552)))
    RubyInterop.each([4, 5]) { |value__hx18625| puts(HXRuby.stringify(value__hx18625)) }
    RubyInterop.with_options([6, 7], prefix: "interop", tags: [:block], count: count__hx18552) do |value__hx18626|
      Kernel.print("interop=")
      puts(HXRuby.stringify(value__hx18626))
    end
