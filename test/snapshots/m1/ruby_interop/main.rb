...
class Main
  ...
  def self.main()
    ...
    puts(HXRuby.stringify(RubyInterop.describe_details(name: "interop", tags: [:safe, :typed], count: count__hx18536)))
    RubyInterop.each([4, 5]) { |value__hx18609| puts(HXRuby.stringify(value__hx18609)) }
    RubyInterop.with_options([6, 7], prefix: "interop", tags: [:block], count: count__hx18536) do |value__hx18610|
      Kernel.print("interop=")
      puts(HXRuby.stringify(value__hx18610))
    end
