...
class Main
  ...
  def self.main()
    ...
    puts(HXRuby.stringify(NativeInterop.describe_details(name: "ruby", tags: [:fast, :typed], count: count__hx19201)))
    NativeInterop.each([1, 2]) { |value__hx19274| puts(HXRuby.stringify(value__hx19274)) }
    NativeInterop.with_options([3, 4], prefix: "item", tags: [:safe], count: count__hx19201) do |value__hx19275|
      Kernel.print("item=")
